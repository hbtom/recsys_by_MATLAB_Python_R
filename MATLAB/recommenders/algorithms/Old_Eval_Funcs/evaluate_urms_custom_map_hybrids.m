function output = evaluate_urms_custom_map_hybrids(urmTest,urmPred1_str,urmPred2_str,urmPred_base1_str,urmPred_base2_str,cut_off_trg,flag_rec)
tic
rng(12563);
...
for u = 1 : size(urmTest,1)
    ...
    if (nz1 == nzref && nz3 == nzref && nz4 == nzref)
        ...
        if mod(p,25000)==1
           ...
           map_ranked_list_aggr_hybrid_thr19(p) = AP_at_k(ranked_list_aggr_hybrid_thr19,pos_items_ids,cut_off_trg);
           map_ranked_list_aggr_hybrid_thr28(p) = AP_at_k(ranked_list_aggr_hybrid_thr28,pos_items_ids,cut_off_trg);
           map_ranked_list_aggr_hybrid_thr37(p) = AP_at_k(ranked_list_aggr_hybrid_thr37,pos_items_ids,cut_off_trg); 
           map_ranked_list_aggr_hybrid_thr46(p) = AP_at_k(ranked_list_aggr_hybrid_thr46,pos_items_ids,cut_off_trg);
           map_ranked_list_aggr_hybrid_thr55(p) = AP_at_k(ranked_list_aggr_hybrid_thr55,pos_items_ids,cut_off_trg);
           map_ranked_list_aggr_hybrid_thr64(p) = AP_at_k(ranked_list_aggr_hybrid_thr64,pos_items_ids,cut_off_trg); 
           map_ranked_list_aggr_hybrid_thr73(p) = AP_at_k(ranked_list_aggr_hybrid_thr73,pos_items_ids,cut_off_trg); 
           map_ranked_list_aggr_hybrid_thr82(p) = AP_at_k(ranked_list_aggr_hybrid_thr82,pos_items_ids,cut_off_trg); 
           map_ranked_list_aggr_hybrid_thr91(p) = AP_at_k(ranked_list_aggr_hybrid_thr91,pos_items_ids,cut_off_trg);
...
fprintf('Evaluation completed! %d evaluated out of %d \n',p,size(urmTest,1))
       ...
       output.map_ranked_list_hybrid_thr19 = mean(map_ranked_list_aggr_hybrid_thr19)  ;
       output.map_ranked_list_hybrid_thr28 = mean(map_ranked_list_aggr_hybrid_thr28)  ;
       output.map_ranked_list_hybrid_thr37 = mean(map_ranked_list_aggr_hybrid_thr37)  ;
       output.map_ranked_list_hybrid_thr46 = mean(map_ranked_list_aggr_hybrid_thr46)  ;
       output.map_ranked_list_hybrid_thr55 = mean(map_ranked_list_aggr_hybrid_thr55)  ;
       output.map_ranked_list_hybrid_thr64 = mean(map_ranked_list_aggr_hybrid_thr64)  ;
       output.map_ranked_list_hybrid_thr73 = mean(map_ranked_list_aggr_hybrid_thr73)  ;
       output.map_ranked_list_hybrid_thr82 = mean(map_ranked_list_aggr_hybrid_thr82)  ;
       output.map_ranked_list_hybrid_thr91 = mean(map_ranked_list_aggr_hybrid_thr91)  ;
