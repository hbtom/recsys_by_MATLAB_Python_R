function output = function_evaluation_script_final_map_hybrid(hybrid_feats,fold_no,cut_off,flag_rec)
...
fold_no
output = evaluate_urms_custom_map_hybrids(urmTest_New,urmPred1_str,urmPred2_str,urmPred_base1_str,urmPred_base2_str,cut_off,flag_rec) ;
save(fullfile(outAddr,'Eval',['Eval_res_HybridBodra_' hybrid_feats '_fld_' ...
