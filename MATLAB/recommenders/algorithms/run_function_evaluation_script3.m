            ...
            for max_ur = [100]
                for rec = 2 : 2
                    ...
                    for fold_no = 1:5
                        ...
                        fileName = ['Rec_res_nn_10_sim_type_cosine_feat_DeepLayerfp7_trailers_fps_1.0_featAggr_AVG_featComb_All_featNorm_SSR2_fld_' num2str(fold_no) 'of5_NEW_sr_' num2str(sr) '_min_ur_' num2str(min_ur) '_max_ur_' num2str(max_ur) '_nusmall_3000.mat'];
                        fileName2 = ['Rec_res_nn_10_sim_type_cosine_feat_audio_ivec_gmm_256_tvDim_400_fld_' num2str(fold_no) 'of5_NEW_sr_' num2str(sr) '_min_ur_' num2str(min_ur) '_max_ur_' num2str(max_ur) '_nusmall_3000.mat'];
                        
                        output = function_evaluation_script_Borda(fileName,fileName2,fold_no,cut_off,rec,'MAP1','MRR','Precision1','Recall1','');
                        
                        for i = 1 : 100
                            tmp = eval(['output.mrr_ranked_list' num2str(i) ';']);
                            output_ivec4_DeepLayerfp7_featAggrAVG_SSR2(fold_no,at,i) = tmp;
                        end
                        
                        
                        fileName = ['Rec_res_nn_10_sim_type_cosine_feat_DeepLayerfp7_trailers_fps_1.0_featAggr_AVG_featComb_All_featNorm_SSR2_fld_' num2str(fold_no) 'of5_NEW_sr_' num2str(sr) '_min_ur_' num2str(min_ur) '_max_ur_' num2str(max_ur) '_nusmall_3000.mat'];
                        fileName2 = ['Rec_res_nn_10_sim_type_cosine_feat_audio_ivec_gmm_512_tvDim_40_fld_' num2str(fold_no) 'of5_NEW_sr_' num2str(sr) '_min_ur_' num2str(min_ur) '_max_ur_' num2str(max_ur) '_nusmall_3000.mat'];
                        
                        output = function_evaluation_script_Borda(fileName,fileName2,fold_no,cut_off,rec,'MAP1','MRR','Precision1','Recall1','');
                        
                        for i = 1 : 100
                            tmp = eval(['output.mrr_ranked_list' num2str(i) ';']);
                            output_ivec5_DeepLayerfp7_featAggrAVG_SSR2(fold_no,at,i) = tmp;
                        end
                        
                        
                        fileName = ['Rec_res_nn_10_sim_type_cosine_feat_DeepLayerfp7_trailers_fps_1.0_featAggr_AVG_featComb_All_featNorm_SSR2_fld_' num2str(fold_no) 'of5_NEW_sr_' num2str(sr) '_min_ur_' num2str(min_ur) '_max_ur_' num2str(max_ur) '_nusmall_3000.mat'];
                        fileName2 = ['Rec_res_nn_10_sim_type_cosine_feat_audio_ivec_gmm_512_tvDim_100_fld_' num2str(fold_no) 'of5_NEW_sr_' num2str(sr) '_min_ur_' num2str(min_ur) '_max_ur_' num2str(max_ur) '_nusmall_3000.mat'];
                        
                        output = function_evaluation_script_Borda(fileName,fileName2,fold_no,cut_off,rec,'MAP1','MRR','Precision1','Recall1','');
                        
                        for i = 1 : 100
                            tmp = eval(['output.mrr_ranked_list' num2str(i) ';']);
                            output_ivec6_DeepLayerfp7_featAggrAVG_SSR2(fold_no,at,i) = tmp;
                        end
...
save('output_ivec456_DeepLayerfp7_featAggrAVG_Norm_SSR2.mat');
