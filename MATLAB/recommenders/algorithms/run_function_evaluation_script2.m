            ...
            for max_ur = [100]
                for rec = 2 : 2
                    ...
                    for fold_no = 1:5
                        ...
                        fileName2 = ['Rec_res_nn_10_sim_type_cosine_feat_tag_cold_per_97_fld_' num2str(fold_no) 'of5_NEW_sr_' num2str(sr) '_min_ur_' num2str(min_ur) '_max_ur_' num2str(max_ur) '_nusmall_3000.mat'];
...
save('bodra_aggr_eval_result_small_ivec_tags97.mat');
