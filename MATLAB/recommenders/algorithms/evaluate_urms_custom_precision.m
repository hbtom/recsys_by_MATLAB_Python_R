function output = evaluate_urms_custom_precision(urmTest,urmPred1_str,cut_off_trg,flag_rec,baselineFeature)
tic
rng(12345);
...
for u = 1 : size(urmTest,1)
    ...
    prec_ranked_list(p) = precision_at_k(ranked_list,pos_items_ids,cut_off_trg);
...
output.prec_ranked_list = mean(prec_ranked_list)  ;
