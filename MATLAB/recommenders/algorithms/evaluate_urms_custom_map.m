function output = evaluate_urms_custom_map(urmTest,urmPred1_str,cut_off_trg,flag_rec,baselineFeature)
tic
rng(12345);
...
for u = 1 : size(urmTest,1)
    ...
    map_ranked_list(p) = AP_at_k(ranked_list,pos_items_ids,cut_off_trg);
...
output.map_ranked_list = mean(map_ranked_list)  ;
